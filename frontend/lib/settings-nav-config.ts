...
export const settingsNavGroups: SettingsNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'integrations', label: 'Integrations', description: 'Connect third-party tools and services', comingSoon: true },
      { key: 'ai-assistant', label: 'AI Assistant', description: 'Configure the AI receptionist and suggestions', comingSoon: true },
