...
function AddPropertyForm({ customerId, onClose, onAdded }: { customerId: string; onClose: () => void; onAdded: () => void }) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setIsSaving(true);
    try {
      await customersApi.createProperty(customerId, form as any);
      onAdded();
    } finally {
      setIsSaving(false);
    }
