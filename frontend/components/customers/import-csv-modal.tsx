        ...
        {!report && (
          <>
            ...
            <input
              ...
              className="block w-full text-sm text-slate-600 dark:text-slate-100 file:mr-3 file:rounded-lg file:border-0 file:bg-slate-100 dark:bg-slate-900 file:px-3 file:py-2 file:text-sm file:font-medium file:text-slate-700 dark:text-slate-100 hover:file:bg-slate-200 dark:placeholder:text-slate-400"
            />
