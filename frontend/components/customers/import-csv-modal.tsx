        ...
        {!report && (
          <>
            <p className="mb-3 text-sm text-slate-600">
              Upload a CSV with a header row. Required: <code className="rounded bg-slate-100 px-1 py-0.5 text-xs">firstName</code> or{' '}
              <code className="rounded bg-slate-100 px-1 py-0.5 text-xs">businessName</code>. Optional columns:{' '}
              <code className="rounded bg-slate-100 px-1 py-0.5 text-xs">lastName, email, phone, customerType, leadStatus, source, tags</code>{' '}
              (tags separated by <code className="rounded bg-slate-100 px-1 py-0.5 text-xs">;</code>).
            </p>
          ...
          <div>
            <div className="grid grid-cols-3 gap-3 text-center">
              <div className="rounded-lg bg-emerald-50 p-3">
                <div className="text-xl font-semibold text-emerald-700">{report.imported}</div>
                <div className="text-xs text-emerald-600">Imported</div>
              </div>
              <div className="rounded-lg bg-slate-50 p-3">
                <div className="text-xl font-semibold text-slate-700">{report.skippedDuplicates}</div>
                <div className="text-xs text-slate-500">Skipped (duplicate)</div>
              </div>
              <div className="rounded-lg bg-red-50 p-3">
                <div className="text-xl font-semibold text-red-700">{report.errors.length}</div>
              ...
              <div className="mt-4 max-h-48 overflow-y-auto rounded-lg border border-slate-200">
                <table className="w-full text-left text-xs">
                  <thead className="sticky top-0 bg-slate-50">
                    <tr>
                      <th className="px-3 py-1.5 font-medium text-slate-500">Row</th>
                      <th className="px-3 py-1.5 font-medium text-slate-500">Reason</th>
                    </tr>
                  </thead>
