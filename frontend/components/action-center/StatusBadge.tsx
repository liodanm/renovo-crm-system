...
export const ESTIMATE_STATUS_COLORS: StatusColorMap = {
  ...
  viewed: { label: 'Viewed', className: 'bg-purple-100 text-purple-700 dark:bg-purple-950 dark:text-purple-300', borderClassName: 'border-purple-300 dark:border-purple-700' },
