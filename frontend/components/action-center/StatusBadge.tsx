...
export const ESTIMATE_STATUS_COLORS: StatusColorMap = {
  ...
  viewed: { label: 'Viewed', className: 'bg-purple-100 text-purple-700 dark:bg-purple-950 dark:text-purple-300' },
  accepted: { label: 'Accepted', className: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-950 dark:text-emerald-300' },
  declined: { label: 'Declined', className: 'bg-red-100 text-red-700 dark:bg-red-950 dark:text-red-300' },
  expired: { label: 'Expired', className: 'bg-orange-100 text-orange-700 dark:bg-orange-950 dark:text-orange-300' },
  converted: { label: 'Converted to Job', className: 'bg-emerald-900 text-white dark:bg-emerald-800' },
};
