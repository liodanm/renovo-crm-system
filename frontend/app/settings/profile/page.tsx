          ...
          <div className="rounded-xl border border-slate-200 bg-white p-4">
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              ...
              <div>
                ...
                <input value={profile.email} disabled className={`${inputClass} mt-1 bg-slate-50 text-slate-400`} />
              ...
              <div>
                <label className="text-xs font-medium text-slate-500">Time Zone</label>
            ...
            <p className="mt-3 text-[11px] text-slate-400">Language preferences are coming soon — currently English only.</p>
          </div>
